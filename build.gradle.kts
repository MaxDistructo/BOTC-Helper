...
dependencies {
    implementation(group = "org.jetbrains.kotlin", name = "kotlin-stdlib", version = "2.2.20")
    ...
    implementation(group = "net.java.dev.jna", name = "jna", version = "5.19.1")
    implementation(group = "net.java.dev.jna", name = "jna-platform", version = "5.19.1")
